...
export default function Navbar(handleMouseDown) {
    ...
    return (
        ...
        <div className="navbar">
            <div className="navbaronlyformobile"><Avatar className="avatarmobile"src="https://cdn-images-1.medium.com/max/1200/1*NpUUls7kjn9JhO4ChjGV7w.png"/>
            <div className="searchboxformobile"><SearchIcon/><input className="searchbarmobile" type="text"/></div>
            ...
            <div className="navbar-right">
             ...
             <div className="avatarcontainedincontainer"> <div className="avatar-container"><NavbarMaterials avatar="https://cdn-images-1.medium.com/max/1200/1*NpUUls7kjn9JhO4ChjGV7w.png" title="me"/></div></div>
